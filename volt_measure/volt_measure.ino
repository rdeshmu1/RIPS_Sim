/*--------------------------------------------------------------
  ...
  Information: https://startingelectronics.org/articles/arduino/measuring-voltage-with-arduino/
--------------------------------------------------------------*/
...
void loop()
{
    ...
    voltage = ((float)sum / (float)NUM_SAMPLES * 4.938) / 1024.0;
    // send voltage for display on Serial Monitor
    // voltage multiplied by 11 when using voltage divider that
    // divides by 11. 11.132 is the calibrated voltage divide
    // value
    Serial.print(voltage * 9.35);
    Serial.println (" V");
    sample_count = 0;
    sum = 0;
}
